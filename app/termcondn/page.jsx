...
const TermsAndConditions = () => {
  return (
    <div className="terms-and-conditions">
      ...
      <p>
        Welcome to https://bookgangaarti.com/ (&quot;Website&quot;). These terms
        and conditions (&quot;Terms&quot;, &quot;Terms and Conditions&quot;)
        govern your relationship with the Website operated by Shree Narayan
        Ganga Aarti (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;, or
        &quot;us&quot;).
      </p>
      <p>
      ...
      <p>
        ...
        the Website and for any activities or actions under your password. You
      ...
      <h2>3. Purchases</h2>
      <p>
        If you wish to purchase any service or product made available through
        the Website (&quot;Purchase&quot;), you may be asked to supply certain
      ...
      <p>
        ...
        are not owned or controlled by Shree Narayan Ganga Aarti.
      </p>
      <p>
        Shree Narayan Ganga Aarti has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any
        third-party websites or services. You further acknowledge and agree that
        Shree Narayan Ganga Aarti shall not be responsible or liable, directly
      ...
      <p>
        In no event shall Shree Narayan Ganga Aarti, nor its directors,
        ...
        the Website; (ii) any unauthorized access to or use of our servers
        and/or any personal information stored therein; (iii) any interruption
        or cessation of transmission to or from the Website; (iv) any bugs,
        ...
        through the Website; and/or (vi) the defamatory, offensive, or illegal
      ...
      <p>
        ...
        agree to the new terms, please stop using the Website.
      </p>
